...
UUIDS = ["89e8ad73-b2e5-4502-8b74-dab92921c8c1", "9196230b-deac-46f2-8b86-ffb7cbc566c0", "d1d6fe65-6df9-422f-9e69-da2c694cc764", "9a891f3d-6573-45da-b42a-52293c37ff7c", "14878d90-01f3-4845-afda-97cce8df5771", "f352f7d9-f1f4-493f-9f87-699c28229191", "e031eda9-f6fb-43cf-a291-8d33fbed0ef6", "ff455523-909b-4bfe-85d6-62ba4ab72796", "8ab1deac-5e61-4911-aca1-3256e00d57dc", "6ec1592a-b14b-4446-a8e2-7678ff56b5ad", "d8c7efab-ffc4-42c3-b537-aae129e72863"]
CHUNKSIZE = 16
USEFILE = False

inputs = (
    ("Imgur URL", ("string", "value=")),
    ("NOTE: The filter can support up to " + str(len(UUIDS)) + " custom Heads by default", "label"),
    ("Use external UUID text file", False),
    )
...
def perform(level, box, options):
    ...
    if external:
        uuidFile = askOpenFile("Select a text file with uuids", False)
        USEFILE = True
        uuids = [line.rstrip('\n') for line in open (uuidFile)]
        slot = random.randint(0,len(uuids))
        uuidToUse = str(uuids[slot])
    else:
        uuidToUse = getRandomUUID()

    toBase64 = '{textures:{SKIN:{url:"' + url + '"}}}'
    cLine = "/give @p minecraft:skull 1 3 {SkullOwner:{Id:" + uuidToUse + ",Properties:{textures:[{Value:" + str(base64.b64encode(toBase64)) + "}]}}}"
