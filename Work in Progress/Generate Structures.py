...
def houseOne(level, x, y, z):
    ...
    level.setBlockAt(x+4, y+3, z+2, 5)
    level.setBlockDataAt(x+4, y+3, z+2, 0)
    level.setBlockAt(x+5, y+3, z+2, 4)
    ...
    level.setBlockDataAt(x+5, y+3, z-2, 0)
    # Right Wall generated
    level.setBlockAt(x+5, y+3, z-1, 5)
    level.setBlockDataAt(x+5, y+3, z-1, 0)
    level.setBlockAt(x+5, y+3, z, 5)
    level.setBlockDataAt(x+5, y+3, z, 0)
    level.setBlockAt(x+5, y+3, z+1, 5)
    level.setBlockDataAt(x+5, y+3, z+1, 0)
    # Back Wall generated
    ...
    level.setBlockDataAt(x+4, y+4, z-2, 0)
    # Last roof row
    level.setBlockAt(x+5, y+4, z, 17)
    level.setBlockDataAt(x+5, y+4, z, 0)
    level.setBlockAt(x+5, y+4, z-1, 17)
    level.setBlockDataAt(x+5, y+4, z-1, 0)
    level.setBlockAt(x+5, y+4, z+1, 17)
    level.setBlockDataAt(x+5, y+4, z+1, 0)
    level.setBlockAt(x+5, y+4, z-2, 17)
